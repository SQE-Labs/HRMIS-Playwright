...
test.describe('Attendance and Leave tests', () => {
    ...
    test(' HRMIS_1 Attendance& Leave accordion expands and displays correct sub-tabs @apply @smoke', async ({ page }) => {
    ...
    test(' HRMIS_2 User navigates to Apply Leave subtab after clicking on it @apply @smoke', async ({ page }) => {
